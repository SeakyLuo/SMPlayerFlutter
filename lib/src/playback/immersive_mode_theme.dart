...
class ImmersiveModeColors {
  const ImmersiveModeColors._();
...
class ImmersiveModeThemeColors
    extends ThemeExtension<ImmersiveModeThemeColors> {
  const ImmersiveModeThemeColors({
  ...
  static const light = ImmersiveModeThemeColors(
    ...
    topButtonForeground: ImmersiveModeColors.dayText,
    topButtonActiveForeground: ImmersiveModeColors.accentStrong,
    text: ImmersiveModeColors.dayText,
    muted: ImmersiveModeColors.dayMuted,
    subtle: Color(0x945b697a),
    artworkBackdropOpacity: 0.92,
    artworkShadowOpacity: 0.22,
  );

  static const dark = ImmersiveModeThemeColors(
    ...
    text: ImmersiveModeColors.nightText,
    muted: ImmersiveModeColors.nightMuted,
    subtle: Color(0xb8ffffff),
    artworkBackdropOpacity: 1,
    artworkShadowOpacity: 0.38,
  );

  static ImmersiveModeThemeColors of(BuildContext context, {bool? night}) {
    if (night != null) {
      return night ? dark : light;
    }
    return Theme.of(context).extension<ImmersiveModeThemeColors>() ?? light;
  }

  @override
  ImmersiveModeThemeColors copyWith() {
    return this;
  }

  @override
  ImmersiveModeThemeColors lerp(
    covariant ThemeExtension<ImmersiveModeThemeColors>? other,
    double t,
  ) {
    return this;
  }
