...
class MediaControlColors {
  ...
  static const playerSurface = Color(0xb8ffffff);
  static const playerAccentWash = Color(0x240078d7);
  static const emptyPlayerAccentWash = Color(0x120078d7);
  static const emptyPlayerLeftWash = Color(0x8cffffff);
  static const emptyPlayerRightWash = Color(0x8ce5f3ff);
  static const playerSurfaceSolid = Color(0xa6ffffff);
