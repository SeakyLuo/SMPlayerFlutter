...
class MediaControlThemeColors extends ThemeExtension<MediaControlThemeColors> {
  ...
  static const light = MediaControlThemeColors(
    ...
    volumeTooltipBackground: Color(0xe6616161),
    volumeTooltipForeground: Colors.white,
    volumeTooltipBorder: Colors.transparent,
  ...
  static const dark = MediaControlThemeColors(
    ...
    volumeTooltipBackground: Color(0xe6ffffff),
    volumeTooltipForeground: Colors.black,
    volumeTooltipBorder: Colors.transparent,
    volumeTooltipShadow: BoxShadow(
      color: Colors.transparent,
      offset: Offset.zero,
