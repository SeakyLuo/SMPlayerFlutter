...
class HeaderedPlaylistThemeColors
  ...
  static const day = HeaderedPlaylistThemeColors(
    ...
    commandControl: Color(0x8fffffff),
    commandControlHover: Color(0xbdffffff),
    commandControlBorder: Color(0x24536379),
    backdropAlphaA: 0.18,
    backdropAlphaB: 0.08,
    backdropBlurAlphaA: 0.24,
    backdropBlurAlphaB: 0.12,
    backdropBlurAlphaC: 0.08,
    backdropBlurAlphaD: 0.06,
