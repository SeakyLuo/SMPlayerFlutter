...
class _MusicDialogResetIcon extends StatelessWidget {
  const _MusicDialogResetIcon({this.size = 20});
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Icon(FluentIcons.arrow_clockwise_20_regular, size: size),
    );
  }
}
